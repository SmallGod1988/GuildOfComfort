...
Все 41 история на карте **уже реализованы в коде**. Деление на полосы —
...
| C | Запуск объекта | администратор | Создать объект → прикрепить заказчика → назначить монтажников |
...
| Активность | Полоса 1 · Скелет (14) | Полоса 2 · Остальной MVP (27) |
| --- | --- | --- |
...
| **C. Запуск объекта** | US-12 Создать объект<br>US-14 Назначить монтажника | US-13 Прикрепить заказчика позже<br>US-15 Снять монтажника<br>US-16 Статус объекта<br>US-17 Все объекты с прогрессом |
...
| **H. Учёт времени** | — | US-34 Внести часы<br>US-35 Свой табель<br>US-36 Сводный табель |
