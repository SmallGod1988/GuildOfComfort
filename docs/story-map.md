...
Все 44 истории на карте **уже реализованы в коде**. Деление на полосы —
...
| B | Справочники и техкарты | администратор | Завести материалы → завести операции с единицей работ → задать нормы на единицу |
...
| Активность | Полоса 1 · Скелет (14) | Полоса 2 · Остальной MVP (29) |
| --- | --- | --- |
...
| **D. Планирование работ** | US-18 Создать подпроект<br>US-19 Создать задачу с объёмом работ | US-20 Задачи подпроекта со статусами<br>US-43 Плановые трудозатраты |
...
| **H. Учёт времени** | — | US-34 Внести часы (бригадир — за бригаду)<br>US-35 Свой табель<br>US-36 Сводный табель<br>US-44 Выгрузка табеля в Excel |
...
| 5 | Заполняется техкарта: нормы на единицу работ | А | US-10 |
...
| 9 | Ставится задача с объёмом работ | А | US-19 |
...
| 13 | Задача завершена, материалы списаны по норме × объём | М | US-29 |
