...
> Документация описывает **реализованную** функциональность. Планируемых и
> гипотетических возможностей здесь нет: если чего-то нет в документах, этого
> нет и в приложении.
>
> **Вики** ([wiki.html](./wiki.html)) пересобрана 22 августа 2026 года по коду
> версии 0.1.1 — это самый свежий документ, начинать стоит с неё. Актуальный
> перечень отсутствующей функциональности — там же, в разделе «Чего нет».
>
> Остальные документы ниже описывают состояние на **4 августа** и местами
> устарели: в них нет ни готовности по деньгам КП, ни блоков работ, ни загрузки
> книги, ни восстановления пароля.
...
| [User stories](./user-stories.md) | Все 44 истории с критериями приёмки и ссылками на реализующий код |
| [Сценарии использования](./use-cases.md) | 12 use cases: актор, предусловия, основной и альтернативные потоки, постусловие |
| [Схема базы данных](./db-schema.html) (HTML) | 14 таблиц с атрибутами, типами, ключами, связями и правилами удаления — техническое описание для разработчика и аналитика |
